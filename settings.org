...
(use-package weyland-yutani-theme
  :load-path "~/clean-emacs/themes/weyland-yutani-theme")
...
:config 
  (setq hl-paren-colors '("#000000" ))  ;"#000000"
  (setq hl-paren-background-colors '("#8196B1" )) ;"#8F7CFF" #56AD1F #a2b2c6 #9AABC1
  )
#+end_src
